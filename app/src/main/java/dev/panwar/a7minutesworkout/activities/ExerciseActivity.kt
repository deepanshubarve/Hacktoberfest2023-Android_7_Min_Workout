...
import dev.panwar.a7minutesworkout.adapter.ExerciseStatusAdapter
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private var restTimer: CountDownTimer? =
        null //time for rest...here we take 10 sec rest...means 10000millis
...
//            putting path of sound...
            val soundURI =
                Uri.parse("android.resource://dev.panwar.a7minutesworkout/" + R.raw.press_start)
...
//        starting 7 lines are just opposite of Setup Exercise view..restricting visibility of exercise view and turning on visibility of rest view
        binding.flRestView.visible()
        binding.tvTitle.visible()
        binding.tvUpcomingExercise.visible()
        binding.tvNextExercise.visible()
        binding.tvExerciseName.invisible()
        binding.flExerciseView.invisible()
...
//        restricting visibility of rest view and turning on visibility of exercise view
        binding.tvUpcomingExercise.invisible()
        binding.tvNextExercise.invisible()
        binding.flRestView.invisible()
        binding.tvTitle.invisible()
        binding.tvExerciseName.visible()
        binding.flExerciseView.visible()
...
// so that it do not keep on speaking long sentences even after activity is destroyed
    ...
    private fun setExerciseProgressBar() {
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration * 1000, 1000) {
            // total 10sec at 1 sec interval at every second what to do
            // these both functions are inbuilt of CountDownTimer class whose object we have created
